...
struct square g_squares[MAX_OBJS];
size_t g_square_count;

struct rect g_cam = {0, 0, 20, 15}; 
...
static void square_vaa_set_up(void)
{
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 
			sizeof(struct square), (void *) 0);
	glVertexAttribIPointer(1, 1, GL_UNSIGNED_INT, 
			sizeof(struct square), (void *) 12);
...
static struct square *alloc_square(void)
{
