...
static struct edit g_edits[MAX_EDITS];
 ...
 * if changes "g_change" is 1.
 *
 * Return: If warning is not displayed, or the OK button
 * is pressed returns 1, elsewise 0 
 */
static int unsaved_warning(void)
{
 ...
 * @ed: Edit
 */
static void resize_edit(struct edit *ed)
{
	int w, h;
 ...
 */
static struct edit *push_edit(void)
{
	struct edit *ed, *br;
